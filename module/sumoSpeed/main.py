...
from module.sumoSpeed.information import MODULE_INSTANCE_INF, MODULE_NAME, MODULE_OUTPUT_INSTANCE_INF
from module.sumoSpeed.run import sumoSpeedRun as runFunc
